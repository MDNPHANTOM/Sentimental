...
class AdminController extends Controller
{
    public function index()
     {
        $users = User::orderBy('score_neg', 'desc')->paginate(20);
     ...
     {
        $posts = Post::where('concern_score', '>', 0.85)->orderBy('created_at', 'desc')->paginate(20);
     ...
     {
        $comments = Comment::where('concern_score', '>', 0.85)->orderBy('concern_score', 'desc')->paginate(20);
     ...
     {
        $posts = Post::where('concern_score', '>', 0.85)->where('user_id', $user->id)->orderBy('concern_score', 'desc')->paginate(20);
     ...
     public function show_user_flagged_comments(Request $request, User $user){
        ...
        $comments = Comment::where('concern_score', '>', 0.85)->where('user_id', $user->id)->orderBy('concern_score', 'desc')->paginate(20);
